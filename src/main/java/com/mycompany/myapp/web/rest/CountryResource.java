...
public class CountryResource {
    ...
    private static final String ENTITY_NAME = "testJhipsterMongodbCountry";
    ...
    public ResponseEntity<Country> createCountry(@RequestBody Country country) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/countries/" + country.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, country.getId()))
            .body(country);
    }
