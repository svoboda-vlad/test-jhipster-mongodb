...
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "testJhipsterMongodbEmployee";
    ...
    public ResponseEntity<Employee> createEmployee(@RequestBody Employee employee) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/employees/" + employee.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, employee.getId()))
            .body(employee);
    }
