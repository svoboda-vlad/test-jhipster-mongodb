...
public class LocationResource {
    ...
    private static final String ENTITY_NAME = "testJhipsterMongodbLocation";
    ...
    public ResponseEntity<Location> createLocation(@RequestBody Location location) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/locations/" + location.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, location.getId()))
            .body(location);
    }
