...
public class RegionResource {
    ...
    private static final String ENTITY_NAME = "testJhipsterMongodbRegion";
    ...
    public ResponseEntity<Region> createRegion(@RequestBody Region region) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/regions/" + region.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, region.getId()))
            .body(region);
    }
