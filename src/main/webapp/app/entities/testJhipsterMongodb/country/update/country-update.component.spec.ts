...
import { RegionService } from 'app/entities/testJhipsterMongodb/region/service/region.service';
...
describe('Country Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Region query and add missing value', () => {
      ...
      const region: IRegion = { id: '0aa1ec44-8f0d-4087-9918-8278cd0412a8' };
      country.region = region;

      const regionCollection: IRegion[] = [{ id: '5079c1ec-8e05-4e3b-ae73-934cf8a30acf' }];
    ...
    it('Should update editForm', () => {
      const country: ICountry = { id: 'CBA' };
      const region: IRegion = { id: '246c7282-bf7f-46e5-ba07-34f2a02580a8' };
      country.region = region;
