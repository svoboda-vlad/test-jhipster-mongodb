...
import { LocationService } from 'app/entities/testJhipsterMongodb/location/service/location.service';
...
describe('Department Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Location query and add missing value', () => {
      ...
      const location: ILocation = { id: '7dc50c76-2ec0-4cc7-ad08-8fb6223146fc' };
      department.location = location;

      const locationCollection: ILocation[] = [{ id: '1d38a6cb-d5c2-4aa4-a8a9-51dd9479175f' }];
    ...
    it('Should update editForm', () => {
      const department: IDepartment = { id: 'CBA' };
      const location: ILocation = { id: '740ff7a5-55a7-45d8-9ff5-5a41d465d0fd' };
      department.location = location;
