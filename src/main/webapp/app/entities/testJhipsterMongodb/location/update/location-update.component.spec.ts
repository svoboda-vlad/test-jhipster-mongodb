...
import { CountryService } from 'app/entities/testJhipsterMongodb/country/service/country.service';
...
describe('Location Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Country query and add missing value', () => {
      ...
      const country: ICountry = { id: 'c32aceb3-d551-406a-9189-7881587f603f' };
      location.country = country;

      const countryCollection: ICountry[] = [{ id: 'd04b63d1-7599-4a8d-b4c8-b0611fed6cdd' }];
    ...
    it('Should update editForm', () => {
      const location: ILocation = { id: 'CBA' };
      const country: ICountry = { id: 'aec7f5c1-6a3a-45f5-974f-a285f520c122' };
      location.country = country;
